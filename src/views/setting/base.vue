      ...
      <el-tabs v-model="activeName">
        <el-tab-pane label="注册与访问" name="first">
          ...
          <el-form-item label="密码最小长度">
            <el-input v-model="form.password_min" type="number" placeholder="密码最小长度" style="width:200px"></el-input>
          </el-form-item>
        ...
        <el-tab-pane label="上传设置" name="second">
          ...
          <el-form-item label="Bucket">
            <el-input v-model="form.upload_config.Bucket" placeholder="Bucket" style="width:200px"></el-input>
          </el-form-item>
          <el-form-item label="ACCESS_KEY">
            <el-input v-model="form.upload_config.ACCESS_KEY" placeholder="ACCESS_KEY" style="width:200px"></el-input>
          </el-form-item>
          <el-form-item label="SECRET_KEY">
            <el-input v-model="form.upload_config.SECRET_KEY" placeholder="SECRET_KEY" style="width:200px"></el-input>
          </el-form-item>
          <el-form-item label="空间域名">
            <el-input v-model="form.upload_config.http" placeholder="空间域名" style="width:200px"></el-input>
            <small class="text-gray-500 ml-1 mt-1">请补全 http:// 或 https://</small>
          </el-form-item>
        </el-tab-pane>
